...
class TrainYoloV10Widget(core.CWorkflowTaskWidget):
 ...
 # Create layout : QGridLayout by default
        ...
        self.combo_model.addItem("yolov10n")
        self.combo_model.addItem("yolov10s")
        self.combo_model.addItem("yolov10m")
        self.combo_model.addItem("yolov10b")
        self.combo_model.addItem("yolov10l")
        self.combo_model.addItem("yolov10x")
